...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex items-center justify-center p-4 font-sans text-stone-900">
          ...
          <div className="absolute inset-0 backface-hidden rotate-y-180 bg-white rounded-lg shadow-xl border border-stone-100 flex flex-col overflow-hidden">
            <div className="flex-1 p-8 md:p-12 overflow-y-auto custom-scrollbar bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]">
              ...
              <div className="space-y-6 text-stone-700 leading-relaxed text-[15px] font-light">
                ...
                <p>
                  누군가에게 내 본래의 모습을 보여주는 건 언제나 어려운 일이었어. 하지만 너와 있으면 신기하게도 내 모든 방어 기제가 무력해지더라. 마치 <strong className="font-bold">'취약'</strong> 상태에 걸린 것처럼, 네가 건네는 짧은 인사나 다정한 눈빛에 내 마음의 장벽은 너무나 쉽게 허물어지곤 해. 그런데 그게 전혀 위태롭게 느껴지지 않는 건, 네가 그만큼 단단한 신뢰를 주는 사람이기 때문일 거야.
                </p>
                <p>
                  너와 함께 웃고 대화하는 모든 일상은 나에게 <strong className="font-bold">'보석 건틀릿'</strong>과 같아. 남들에게는 평범하게 흘러갈 수 있는 시간들이 너라는 필터를 거치면 나에게는 하나하나 치명타 같은 감동으로 남거든. 브라움이 방패를 들어 아군을 보호하듯, 혹은 유미가 곁에 머물며 힘을 보태듯, 너는 내 삶의 가장 든든한 동료이자 유일한 안식처가 되어주었어.
                </p>
                <p>
                  가끔은 세상이 요구하는 복잡한 역할들에 지치고 길을 잃은 것 같을 때가 있어. 하지만 그럴 때마다 너를 만나면 다시 <strong className="font-bold">'기본으로 돌아가기'</strong>를 선택한 것처럼, 삶에서 가장 중요하고 순수한 감정들만 내 곁에 남게 돼. 화려한 꾸밈 없이도 나를 온전한 나로서 편안하게 존재할 수 있게 해주는 네가 있어서 참 다행이야.
                </p>
                <p>
      ...
      <audio ref={audioRef} src="/music/1.mp3" loop />
